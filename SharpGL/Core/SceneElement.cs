...
namespace SharpGL
{
    ...
    [XmlInclude(typeof(Axies))]
    [XmlInclude(typeof(Grid))]
    [XmlInclude(typeof(Quadric))]
    [XmlInclude(typeof(Cylinder))]
    [XmlInclude(typeof(Disk))]
    [XmlInclude(typeof(Sphere))]
    [XmlInclude(typeof(Light))]
    [XmlInclude(typeof(LinearTransformationEffect))]
    [XmlInclude(typeof(OpenGLAttributesEffect))]
    public partial class SceneElement
    {
        ...
        [Description("The object name."), Category("Scene Element")]
        [XmlAttribute]
        public int Empilhamento_Ilimitado
        {
            get;
            set;
        }
        ...
        [Description("The object name."), Category("Scene Element")]
        [XmlAttribute]
        public int Empilhamento_Restricao
        {
            get;
            set;
        }
        ...
        [Description("The object name."), Category("Scene Element")]
        [XmlAttribute]
        public float Empilhamento_Peso_Maximo
        {
            get;
            set;
        }
        ...
        [Description("The object name."), Category("Scene Element")]
        [XmlAttribute]
        public string Existe_Produto_Em_Cima
        {
            get;
            set;
        }
